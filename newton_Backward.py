...
# Calculate p using LAST x value
p = (xp - x[n - 1]) / h
...
for i in range(1, n):
    ...
    # Extract backward differences from last valid entries
    backward_diff = diff_table[n - i - 1][i]

    result += (p_term * backward_diff) / math.factorial(i)
